package com.objectpartners.buesing.streams.util;
...
public class KdTree<T extends KdTree.XYZPoint> implements Iterable<T> {
    ...
    public static class Point extends XYZPoint {

        private String zip;

        public Point(Double latitude, Double longitude, String zip) {
    ...
    public static void main(String[] args) {
        ...
        final KdTree<Point> tree = new KdTree<>();
        ...
        parserSettings.setProcessor(new RowProcessor() {
            ...
            public void rowProcessed(String[] row, ParsingContext context) {
                ...
                String zip = row[0];
                System.out.println(lat + " : " + lng + " : " + zip);
                tree.add(new Point(lat, lng, zip));
            }
        ...
        parser.parse(new File("/Users/buesing/Downloads/zc/zipcode.csv"));


        //tree.add()

        Point x = new Point(18.5, -66.7, null);

        Collection<Point> c = tree.nearestNeighbourSearch(1, x);

        System.out.println("** " + c.size());
        c.stream().forEach(i -> System.out.println(i.getZip()));
    }
}
